...
<section id="centerMainpage">
	<div class="container center__header__bottom">
		<p class="h6" title="공지사항 목록으로"><strong onclick="document.getElementById('goToNoticeList').submit();">공지사항&nbsp;&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#559977" class="bi bi-megaphone-fill" viewBox="0 0 20 20">
