                     ...
                     <c:if test="${login.us_id == mb_list.bo_id}">   
                        ...
                        <div class="row detail-comment">
                            ...
                            <div class="col-lg-12">
                                <table border="1">
                                    <tr>
                                        <td><textarea placeholder="상품 문의 등록">${mypage.my_image}</textarea></td>
                                    </tr>
                                    <tr>
						       ...
						       <div class="modal-content">
						          ...
						          <div class="modal-body">
						            ...
						            <!--  <div class="form-group">
						             ...
						             <div class="form-group">
						                <label>작성일</label>
						                <input class="form-control" name="re_regdate" value="">
						             </div>
						          </div>
...
<script>
    $(document).ready(function(){
        ...
        var modalInputRename = $(document).find("input[name='re_name']");
        var modalInputReplyDate = modal.find("input[name='re_regdate']");
        var modalReprofileInput = $(document).find("input[name='re_profile']"); 
     ...
     // 0817 - 댓글 삭제 - remove
        ...
        modalRegisterBtn.on("click",function(e){
           ...
           replyService.add(replys, function(result){
              ...
              modal.find("input").val("");
              modal.modal("hide");
              showList(-1);  // showList의 if(page == -1)을 탄다.
           })
        ...
        $(".comment-show").on("click","div", function(){
       	 ...
       	 replyService.get(re_num, function(reply){
       		...
       		modalInputRename.val(reply.re_name);
       		modalInputReplyDate.val(
