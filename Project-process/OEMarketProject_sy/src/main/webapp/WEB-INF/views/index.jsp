								...
								<div class="item">
									<div class="thumb">
										<div class="hover-content">
											<a onclick="location.href='board/boardDetail?bo_num=${he_list.bo_num}&align=&bo_id=${login.us_id}'"><img src="/resources/assets/images/eye-white.png" /></a>
										</div>
							...
							<c:forEach items="${rg_list}" var="rg_list" begin="1" end="6"
								...
								<div class="item">
									<div class="thumb">
										...
										<div class="hover-content">
											<a onclick="location.href='board/boardDetail?bo_num=${rg_list.bo_num}&align=regdate&bo_id=${login.us_id}&bo_nickname=${login.us_nickname}'"><img src="/resources/assets/images/eye-white.png" /></a>
										</div>
