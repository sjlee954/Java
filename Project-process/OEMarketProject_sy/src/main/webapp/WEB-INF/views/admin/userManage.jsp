			...
			<div class="col-lg-12">
				...
				<div class="inner-content">
					<table>
						<thead>
							<tr>
								<th class="admin_head_">아이디</th>
								<th class="admin_head_">닉네임</th>
								<th class="admin_head_">이름</th>
								<th class="admin_head_">가입일</th>
								<th class="admin_head_">게시글 수</th>
								<th class="admin_head_">댓글 수</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${ad_user}" var="ad_user">
<%-- 								<li><a	href="${contextPath}/mypage/mypage?my_id=<c:out value='${login.us_id }'/>">${login.us_nickname }님</a></li> --%>
								<tr>
									<th><c:out value="${ad_user.us_id}" /></th>
									<th><a href="${contextPath}/mypage/mypage?my_id=<c:out value='${ad_user.us_id}'/>">${ad_user.us_nickname}</a></th>
									<th><c:out value="${ad_user.us_name}" /></th>
									<th><fmt:formatDate pattern="yyyy-MM-dd" value="${ad_user.us_joindate }"/></th>
