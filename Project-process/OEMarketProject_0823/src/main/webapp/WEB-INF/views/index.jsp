								...
								<div class="item">
									<div class="thumb">
										<div class="hover-content">
											<ul>
												<li><a onclick="location.href='board/boardDetail?bo_num=${he_list.bo_num}&align=&bo_id=${login.us_id}'"><i class="fa fa-eye"></i></a></li>
											</ul>
										</div>
							...
							<c:forEach items="${rg_list}" var="rg_list" begin="1" end="6"
								...
								<div class="item">
									<div class="thumb">
										...
										<div class="hover-content">
											<ul>
												<li><a onclick="location.href='board/boardDetail?bo_num=${rg_list.bo_num}&align=regdate&bo_id=${login.us_id}&bo_nickname=${login.us_nickname}'"><i class="fa fa-eye"></i></a></li>
											</ul>
										</div>
