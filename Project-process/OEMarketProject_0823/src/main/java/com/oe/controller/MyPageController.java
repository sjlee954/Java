...
public class MyPageController {
	...
	public void get(String my_id, Model model, MyPageVO vo) {
...
//		log.info("mypage : " + service.get(my_id));
//		log.info(service.getmyCountHB(my_id));
		
//		rttr.setAttribute("mypage", mypageService.get(vo.getUs_id()));
	}
...
//		session.setAttribute("login", vo.getMy_nickname());
		
//		log.info("vo-nickname : " + vo.getMy_nickname());
