...
public class MyPageServiceImpl implements MyPageService {
	...
	@Override public void nickEdit_cr_seller(MyPageVO vo) {
	  log.info("nickEdit_cr_seller★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★");
	  mapper.updateNick_cr_seller(vo); 
	}
	  
	@Override public void nickEdit_cr_buyer(MyPageVO vo) {
	...
	*/
	...
	@Override
	public void imageEdit_reply(MyPageVO vo) {
		mapper.updateImage_reply(vo);
	}
}
