...
.profileRightSide .introZone #introTextArea{margin-left: 17px; height:170px; min-width: 400px; resize: none; padding: 10px 20px;}
...
.goDetail .runFrm{width: 240px; height:360px; border-radius: 25px; cursor: pointer;}
