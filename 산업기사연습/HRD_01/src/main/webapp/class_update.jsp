...
<body>
	...
	<section>
		<form action="class_update_impl.jsp" method="get">
					<input type="hidden" name="class_seq" value=<%=vo.getClass_seq() %>>
			<table border="1">
				<tr>
					<td>개강월</td>
				...
				<tr>
					<td>과정번호</td>
					<td><input type="text" name="c_no" style="float: left;" value=<%=vo.getC_no() %> readonly="readonly"></td>
				</tr>
				<tr>
					<td>캠퍼스</td>
