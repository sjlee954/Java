...
<body>
	...
	<section>
		<form action="member_update_impl.jsp">
			<table border="1">
				<tr>
					<td>순번</td>
					<td><input type="text" name="member_seq" style="float: left;" value=<%=vo.getMember_seq()%> readonly="readonly"></td>
				</tr>
				<tr>
					<td>과정코드</td>
				...
				<tr>
					<td>수강등급</td>
					<td><input type="text" name="c_type" style="float: left;" value=<%=vo.getTeacher_name() %>></td>
				</tr>
				<tr>
					<td colspan="2">
