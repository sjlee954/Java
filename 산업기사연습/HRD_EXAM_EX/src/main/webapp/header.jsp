...
<style type="text/css"> 
	*{margin:0; padding:0;}
	header{height: 150px; background-color: blue; color: white; text-align: center; line-height: 150px;}
		
		nav{background-color: RoyalBlue; height: 35px; line-height: 35px;}
		nav ul li {float: left; margin: 0 30px; list-style: none;}
		nav ul li a{text-decoration: none; color: white; line-height: 35px;}
		
		section{height: 700px; background-color: Gainsboro;}
